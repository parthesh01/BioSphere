...
const Hero = () => {
  ...
  return (
    <div className='relative w-screen overflow-x-hidden h-dvh'>
      ...
      {isLoading && (
        <div className='absolute w-screen overflow-hidden flex-center z-[100] h-dvh bg-violet-50'>
        ...
        <div id='video-frame' className='relative z-10 w-screen overflow-hidden rounded-lg bg-blue-75 h-dvh'>
          <div>
            ...
            <h1 className='absolute z-40 special-font hero-heading bottom-5 right-5 text-blue-75'>
              ...
              <div className='absolute top-0 left-0 z-40 size-full'>
                <div className='px-5 mt-24 sm:px-10'>
                  ...
                  <p className='mb-5 text-blue-100 max-w-64 font-robert-regular'>Enter the Metagame Layer<br />The New Ecosystem for Gamers</p>
